...
const Login: React.FC = () => {
  ...
  return (
    <div style={{ maxWidth: 400, margin: '2rem auto', padding: '2.5rem', background: darkBg, borderRadius: '1.2rem', boxShadow: `0 4px 32px ${neonBlue}33`, color: neonBlue, fontFamily: 'Orbitron, sans-serif', border: `2px solid ${neonPink}` }}>
      ...
      <a href="/api/oauth2/authorization/google" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', background: 'white', color: '#222', border: 'none', borderRadius: '0.5rem', padding: '0.75rem', fontWeight: 'bold', fontSize: '1.1rem', boxShadow: `0 0 8px ${neonBlue}`, textDecoration: 'none', transition: 'background 0.2s', cursor: 'pointer' }}>
        <GoogleLogo />
        Login with Google
      </a>
    </div>
